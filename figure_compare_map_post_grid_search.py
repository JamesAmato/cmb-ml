...
def show_map(combo):
    ...
    map_fn1 = "/data/jim/CMB_Data/Datasets/I_512_1450/{}/Analysis_D_Common_Post_Map_Real/Test/sim0000/cmb_real_post_{}_{}_{}.fits"
    map_fn2 = "/data/jim/CMB_Data/Datasets/I_512_1450/{}/Analysis_E_Common_Post_Map_Pred/Test/sim0000/cmb_pred_post_{}_{}_{}.fits"
    ...
    fn = f"map_imgs3/{mask_out_str}_{working_dir}_{masking}_{dconv_str}_{remove_dipole_str}.png"
...
working_dirs = ["CMBNNCS", "PyILC_HILC"]
