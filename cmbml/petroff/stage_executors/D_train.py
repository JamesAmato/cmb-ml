...
from cmbml.core.pytorch_transform import TrainToTensor, train_remove_map_fields
    ...
    def execute(self) -> None:
        ...
        for epoch in range(start_epoch, self.n_epochs):
            ...
            with tqdm(dataloader, postfix={'Loss': 0}) as pbar:
                for train_features, train_label in pbar:
                    ...
                    with torch.no_grad():
                        ...
                        this_loss = loss.item() / self.batch_size
            ...
            with torch.no_grad():
                ...
                if epoch < 5:
                    logger.info(", ".join([f"{l:.05f}" for l in loss_list]))
                loss_list = []
