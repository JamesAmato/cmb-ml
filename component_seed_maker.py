...
class SeedMaker:
    def __init__(self, conf, sky_component, use_backup_strs=False) -> None:
    ...
    def get_component_string(self, conf, sky_component):
        try:
